...
interface Insight2Layer3ClientProps {
  content: string;
}

export function Insight2Layer3Client({ content }: Insight2Layer3ClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-cream-50 to-cream-100">
      ...
      <div className="w-full max-w-2xl mx-auto px-4 pt-8 pb-4 space-y-2">
        <BackButton href="/insight-2/layer-2" label="Back" />
        <div className="flex items-center justify-between">
          ...
          >
            Insight 2 · Layer 3 — Full Insight
          </motion.span>
